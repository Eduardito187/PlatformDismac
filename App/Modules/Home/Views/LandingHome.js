            ...
            <View style={SCREEN_RELATIVE}>
                ...
                <View style={SCREEN_ABSOLUTE_BODY}>
                    <ScrollView showsVerticalScrollIndicator={false} style={SCROLL_STYLE}>
                        ...
                        {Campain.length > 0 && (<Campains width={windowWidth-20} height={100} data={Campain} />)}
                        {SocialNewtwork.length > 0 && (<Socials width={windowWidth-20} height={100} data={SocialNewtwork} />)}
