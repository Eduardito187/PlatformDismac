...
import { Border_Radius_5, CONTIANER_LOADING, RED_DIS, Size_20 } from '../../../Login/Style/css';
...
const Campains = (props) => {
    ...
    const _renderItem = ({item, index}) => {
        return (
            <Card key={Math.random()+'_Campains_'+Math.random()} style={[{width: props.width, height: props.height}, Border_Radius_5]}>
